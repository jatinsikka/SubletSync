...
const DEMO_LISTINGS = [
  {
    id: 'demo-1',
    title: 'Bright Studio Near MIT — Utilities Included',
    address: '84 Massachusetts Ave, Unit 2',
    city: 'Cambridge', state: 'MA',
    price: 1350, bedrooms: 0, bathrooms: 1, sqft: 400,
    description: 'Sun-drenched studio steps from MIT and the Charles River. Hardwood floors, updated kitchen, huge windows. Perfect for a grad student or summer intern. Walking distance to Central Sq, Whole Foods, and great coffee shops. Quiet building with respectful neighbors. Water and electric included.',
  ...
  {
    id: 'demo-2',
    title: 'Modern 1BR in Lincoln Park',
    address: '2144 N Halsted St, Apt 4B',
    city: 'Chicago', state: 'IL',
    price: 1150, bedrooms: 1, bathrooms: 1, sqft: 680,
    description: 'Beautiful one-bedroom in the heart of Lincoln Park, 0.3 mi from Northwestern Law. Open floor plan, stainless appliances, private balcony. Building has rooftop access, gym, and secure parking. In-unit washer/dryer included.',
  ...
  {
    id: 'demo-3',
    title: 'Private Room in 3BR Ann Arbor House',
    address: '412 E William St',
    city: 'Ann Arbor', state: 'MI',
    price: 580, bedrooms: 1, bathrooms: 1, sqft: 190,
    description: "Private furnished room in a charming craftsman house just off central campus. Two super friendly roommates (both grad students). Shared kitchen, living room, and backyard. Street parking available. Bikes welcome. Walking distance to the Diag, Law Quad, and State St restaurants.",
  ...
  {
    id: 'demo-4',
    title: 'Spacious 2BR Near UCLA — Summer Sublet',
    address: '10940 Wilshire Blvd, Unit 201',
    city: 'Los Angeles', state: 'CA',
    price: 1800, bedrooms: 2, bathrooms: 2, sqft: 980,
    description: "Gorgeous corner unit just minutes from UCLA campus. Two full bedrooms, two full baths — perfect for two friends subletting together. Resort-style pool, fitness center, and 24/7 concierge. Walking distance to Westwood Village and the 405 corridor.",
    available_from: '2026-05-15', available_to: '2026-08-15',
    furnished: true, sublease_type: 'whole_unit',
  ...
  {
    id: 'demo-5',
    title: 'Cozy Room — Morningside Heights',
    address: '520 W 114th St, Rm 3',
    city: 'New York', state: 'NY',
    price: 1100, bedrooms: 1, bathrooms: 1, sqft: 160,
    description: 'Private room in a sunny Morningside Heights apartment, steps from Columbia. One other roommate, very chill. Great access to Riverside Park, tons of cafés, and the 1/A/C/B trains. Perfect for a summer research position or internship in the city.',
  ...
  {
    id: 'demo-6',
    title: 'Luxury 1BR Near Duke — Furnished',
    address: '805 W Trinity Ave, Unit 18',
    city: 'Durham', state: 'NC',
    price: 1100, bedrooms: 1, bathrooms: 1, sqft: 750,
    description: "Stunning one-bedroom just 10 minutes from Duke's West Campus. High ceilings, premium finishes, private balcony. Concierge building, rooftop lounge, private dog park. Walkable to 9th Street dining district. Fully furnished with quality pieces — move-in ready.",
    available_from: '2026-06-01', available_to: '2026-08-31',
    furnished: true, sublease_type: 'whole_unit',
  ...
  {
    id: 'demo-7',
    title: 'Capitol Hill Studio — Seattle Summer',
    address: '219 Broadway E, #302',
    city: 'Seattle', state: 'WA',
    price: 1250, bedrooms: 0, bathrooms: 1, sqft: 410,
    description: "Perfect for someone interning at Amazon, Microsoft, or any Seattle tech company. Efficient studio in vibrant Capitol Hill. Very quiet building, all professionals. Updated bath, walk-in closet, controlled-access parking. Walkable to Cal Anderson Park and tons of restaurants.",
    available_from: '2026-05-01', available_to: '2026-07-31',
    furnished: false, sublease_type: 'whole_unit',
  ...
  {
    id: 'demo-8',
    title: 'Ponce City 3BR — Atlanta Summer',
    address: '650 North Ave NE, House',
    city: 'Atlanta', state: 'GA',
    price: 1600, bedrooms: 3, bathrooms: 2, sqft: 1300,
    description: 'Classic bungalow near Georgia Tech and Ponce City Market. Ideal for a friend group subletting together for the summer. Huge covered porch, backyard with grill, original hardwood throughout. All three rooms available — lease the whole house. Landlord is awesome and flexible.',
